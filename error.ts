...
/**
 * This class provides a wrapper for network errors when making requests to Visier User Management APIs
 */
export class VisierUserManagementError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierUserManagementError";
